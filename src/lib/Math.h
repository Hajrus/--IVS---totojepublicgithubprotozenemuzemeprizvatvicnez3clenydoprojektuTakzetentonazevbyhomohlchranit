 ...
 * 
 * @brief Math class header file - math library
 */


/**
 * Math class, implementation of mathematical library for Calculator 
 * with basic mathematical operations
 * 
 * @brief Math class - Calculator with basic mathematical operations
 */  
class Math
{
    public:
